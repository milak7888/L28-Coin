...
Foundation 12 adds offline backup and verified recovery. Backups are unencrypted, unaudited for authorship, and locally correlatable; operators must quiesce registries before backup or restore. See [registry_backup_recovery_v0.1.md](registry_backup_recovery_v0.1.md).
