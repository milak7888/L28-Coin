...
if __name__ == "__main__":
    ...
    def sign_transaction(self, wallet_name: str, data: bytes) -> str:
        """
        Sign transaction data with wallet's private key
    ...
    def verify_signature(self, public_key_hex: str, signature_hex: str, data: bytes) -> bool:
        """
